...
*/
// 1. 지정한 id의 dom 객체를 가져오기
const h1 = document.querySelector('#title')
console.log(h1); //
// 2. 가져온 dom 객체내 innerHTML 대입하기
...
function func8(){   // onclick: 해당 마크업 클릭했을때 발생, onchange : 해당 마크업 value 변경 되었을때 변경
...
function func9(){                                           console.log('---func9 exe---');
    ...
    //7. 배열내 모든 요소 HTML(문자열) 형식 구성(*누적합계와 비슷)
