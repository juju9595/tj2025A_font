...
// 1. 자동 형 변환
    // (1) 문자열형의 숫자에 곱하기 1를 하면 문자열 숫자가 숫자형 숫자로 변환한다. "10" vs 10
let input = prompt("숫자를 입력하세요.")            // 5 , prompt 함수는 항상 문자열 반환한다.
...
console.log( Number("10") ) ;       // "10" --> 10 변화
...
//생각해보기1: 국어 점수 와 수학 점수를 prompt 로 입력받아 국어점수 외 수학점수를 더한 결과를 console.log 출력하시오.
    // 출력예] 총합계 : 150
// (1)입력받기 , prompt
// (2) 저장하기, 변수
...
// (4) 출력하기 , console ,  템플릿 리터fjf `(백틱)
console.log( `총합계 : ${합계점수}`) // vs "총합계 : " + 합계점수
    // 컴퓨터는 기존적인 프로세스 : (입력) -> (처리) -> (출력)
