...
// 4. doumeny. querySelector("선택자").value       : 특정한 선택자의 value속성의 값 호출

// [변수와 입력함수] * 입력받은 결과물을 변수에 저장.
// 1. let 변수명 = confirm();
    // confirm( "확인 또는 취소 클리하세요.")     :브라우저에서 확인/취소 선택 받는다.
    // let result1 = true 또는 false
let result1 = confirm( "확인 또는 취소 클릭하세요.")
console.log( result1 )// ,사용자 확인 클릭시 true 출력, 취소 클리시 false 출력
