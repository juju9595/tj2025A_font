...
[변수]
    1. *하나*의 자료/데이터 를 담아 두는 (메모리) 공간
    2. 목적 : 재사용성, 가독성
    3. 사용법
        1. (변수를 선언하는 방법) : 초기값이 없다. *초기값이란? 변수 선언(만들)할때 대입되는 값
            let 변수명
            (변수를 선언하는 방법2) : 초기값이 있다.
            let 변수명 = 자료/값
    4. 형태
        1. let      : 변수를 선언하기 위한 키워드/명렁어
...
이름3 = "신동엽2" // 오류발생 : Assignmnet to constant variable.

// [생각해보기1]
let point1 = 50                    // 변수명 : point1 , 리터럴 : 50
let point2 = 100                   // 변수명 : point2, 리터럴 : 100
let point3 = poing1 + point2       // 변수명 : point3 , 리터럴 : 150
    // 위 코드에서 총 리터럴의 개수 ? 3개
    // + 연산 : 계산을 통해 하나의 결과를 도출하는 행위


let widht   // 'width' 이름으로 변수를 선언한다.
